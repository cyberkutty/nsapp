          ...
          <ul className="nav flex-column">
            ...
            <li className="nav-item">
              ...
              <div className={`submenu ps-3 ${activeMenu === 'employees' ? 'show bg-submenu' : ''}`}>
                <NavLink to="/attend" className="nav-link nested-submenu">Students Attendance</NavLink>
            ...
            <li className="nav-item">
              ...
              <div className={`submenu ps-3 ${activeMenu === 'marketing' ? 'show bg-submenu' : ''}`}>
                <NavLink to="/activities" className="nav-link nested-submenu">Activities</NavLink>
                <NavLink to="/seminar" className="nav-link nested-submenu">Seminar</NavLink>
            ...
            <li className="nav-item">
              ...
              <div className={`submenu ps-3 ${activeMenu === 'reports' ? 'show bg-submenu' : ''}`}>
                ...
                <NavLink to="/cro/demo" className="nav-link nested-submenu">Demo Details</NavLink>
                 <NavLink to="/techattendrepo" className="nav-link nested-submenu">Students Attendance</NavLink>
